...
func TestManager_CreateExampleYAML(t *testing.T) {
    ...
    // Update expectation to 9 providers (local-lmstudio + 8 LLM providers)
    require.Len(t, cfg.Providers, 9, "Expected 9 providers including local-lmstudio, ollama, deepseek, groq")
    ...
    expectedProviders := []string{"openrouter", "local-lmstudio", "openai", "anthropic", "nvidia", "gemini", "ollama", "deepseek", "groq"}
